...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define make-sgml-lexer
  (lambda [consume-token]
    (λ [/dev/drin offset mode]
      (define-values (t next-mode) (consume-token /dev/drin '/dev/drin mode))
...
(define xml-lexer (make-sgml-lexer xml-consume-token*))
(define rnc-lexer (make-sgml-lexer rnc-consume-token*))
